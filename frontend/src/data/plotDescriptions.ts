/**
 * Mismos textos que `src/api-v1/analyses/analyses-plot-index-texts.ts` (PDF) y alineados con
 * GET /v1/analyses/indices. Si editas uno, mantén el otro coherente.
 */
...
export function plotIndexDescription(plotKey: string): string {
  return (
